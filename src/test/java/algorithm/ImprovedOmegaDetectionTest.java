...
public class ImprovedOmegaDetectionTest {
    ...
    public void testTransitionUtilsOptimizations() {
        ...
        // All three markings have P0 >= 1, so T0 (requires P0 >= 1) is
        ...
        // Test batch enabling check: T0 is enabled in all three markings.
        ...
        // Test count enabled: T1 requires P1 >= 1. Only the first two
        // markings satisfy that; the third has P1=0. So countEnabledIn
        // must return 2.
